...
set JARPATH=%APP_HOME%\lib\Recipe_Management_System-task.jar

@rem Execute Recipe_Management_System-task
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %RECIPE_MANAGEMENT_SYSTEM_TASK_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%RECIPE_MANAGEMENT_SYSTEM_TASK_EXIT_CONSOLE%" exit 1
exit /b 1
